              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="mu-header-top-left">
                  <div class="mu-top-email">
                    ...
                    <span>kontak.bemfmipaunnes@gmail.com</span>
                  </div>
    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- IMG BASED LOGO  -->
          <a class="navbar-brand" href="/bemfmipa/"><img src="assets/img/logo cilik.png" alt="logo"></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li class="active"><a href="/bemfmipa/">Home</a></li>            
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Profile <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="profil/">BEM FMIPA 2019</a></li>                
                <li><a href="visimisi/">Visi Misi</a></li>
                <li><a href="struktur/">Struktur Organisasi</a></li>
                <li><a href="logo/">Logo Kabinet</a></li>                    
              </ul>
            </li>           
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="aspirasi/kirim/">Kirim Aspirasi</a></li>                
                <li><a href="aspirasi/faq/">FAQ</a></li>                
              </ul>
            </li>            
  ...
  <section id="mu-slider">
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="assets/img/tolo(2).jpg" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
        <h4>Selamat Datang di Website BEM FMIPA 2019!</h4>
        <span></span>
        <h2>BEM FMIPA 2019</h2>
        <p></p>
        <a href="profil/" class="mu-read-more-btn">Read More</a>
      </div>
    </div>
    <!-- Start single slider item -->
    <!-- Start single slider item -->
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="assets/img/tolo 2(1).jpg" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
        <h4>Selamat Datang di Website BEM FMIPA 2019!</h4>
        ...
        <h2>Logo Kabinet</h2>
        <p></p>
        <a href="logo/" class="mu-read-more-btn">Read More</a>
      </div>
    </div>
    <!-- Start single slider item -->
    <!-- Start single slider item -->
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="assets/img/tolo 3(2).jpg" alt="img">
        </figure>
      </div>
      <div class="mu-slider-content">
        <h4>Selamat Datang di Website BEM FMIPA 2019!</h4>
        ...
        <h2>Visi Misi</h2>
        <p></p>
        <a href="visimisi/" class="mu-read-more-btn">Read More</a>
      </div>
    </div>
    <!-- Start single slider item -->    
  </section>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="mu-service-area"> -->
            ...
            <!-- <div class="mu-service-single" style="margin-left: 16.9%;">
           ...
           <!--  <div class="mu-our-teacher-content">
              <div class="row">
                <div class="col-lg-3 col-md-3  col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="assets/img/logo bem 260x265.png" alt="teacher img">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="assets/img/logo 260x265.png" alt="teacher img" style="padding-bottom : 69px;">
                      <div class="mu-our-teacher-social">
                        <a href="#"><span class="fa fa-facebook"></span></a>
                        <a href="#"><span class="fa fa-twitter"></span></a>
                        <a href="#"><span class="fa fa-linkedin"></span></a>
            ...
            <div id="mu-testimonial-slide" class="mu-testimonial-content"> -->
             ...
             <!--  <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-info">
                  <h4>John Doe</h4>
                  <span>Gubernur BEM FMIPA 2016</span>
                </div>
              </div> -->
              ...
              <!-- <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-info">
                  <h4>Rebaca Michel</h4>
                  <span>Gubernur BEM FMIPA 2017</span>
                </div>
              </div> -->
              <!-- end testimonial single item -->
              <!-- start testimonial single item -->
             <!--  <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-info">
                  <h4>Stev Smith</h4>
                  <span>Gubernur BEM FMIPA 2018</span>
                </div>
              </div> -->
              <!-- end testimonial single item -->
            <!-- </div>
            ...
            <!-- <div class="mu-from-blog-content">
              <div class="row">
                <div class="col-md-4 col-sm-4">
                  <article class="mu-blog-single-item">
                    <figure class="mu-blog-single-img">
                      <a href="#"><img src="assets/img/750x500 iklan bem.png" alt="img"></a>
                ...
                <div class="col-md-4 col-sm-4">
                  <article class="mu-blog-single-item">
                    <figure class="mu-blog-single-img">
                      <a href="#"><img src="assets/img/750x500 iklan.png" alt="img" style="padding-top: 10%;padding-bottom: 18%;"></a>
                      <figcaption class="mu-blog-caption">
                        <h3><a href="#">Lorem ipsum dolor sit amet.</a></h3>
                      </figcaption>                      
                    </figure>
    ...
    <div class="mu-footer-bottom">
      <div class="container">
        <div class="mu-footer-bottom-area">
          <p>&copy; All Right Reserved. Developed with &hearts; by KOMINFO BEM FMIPA UNNES 2019</p>
        </div>
      </div>
    </div>
    <!-- end footer bottom -->
